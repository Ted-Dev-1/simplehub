...
<?php $pageClass = "about-page"; include("includes/header.php");?>
          ...
          <div class="col-lg-7">
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane fade show active" id="about-2-tab1">
                ...
                <p class="fst-italic">At Gear Nexus, we are more than just a repair shop, we are a hub of innovation and excellence in both automotive and aircraft maintenance. Our highly skilled team of certified mechanics brings years of expertise, ensuring that every vehicle and aircraft we service is handled with precision, care, and the latest technology</p>
                ...
                <div class="d-flex align-items-center mt-4">
                  ...
                  <h4>Comprehensive Car Repairs</h4>
                </div>
                <p>From engine diagnostics to brake replacements and suspension fixes, we handle it all with cutting-edge tools and expert precision.</p>

                <div class="d-flex align-items-center mt-4">
                  <i class="bi bi-check2"></i>
                  <h4>Aircraft Maintenance & Repairs</h4>
                </div>
                <p>Our aviation specialists ensure aircraft are maintained at the highest standards, covering inspections, engine servicing, and structural repairs.</p>

                <div class="d-flex align-items-center mt-4">
                  <i class="bi bi-check2"></i>
                  <h4>Car Wash & Detailing</h4>
                </div>
                <p>We go beyond mechanics, offering premium cleaning and detailing services to keep your car spotless, inside and out.</p>
